...
public class product extends AppCompatActivity {
    ...
    private class TsunamiAsyncTask extends AsyncTask<URL, Void, String> {
        ...
        private void updateui(){
           ...
           // adapter2 Adapter = new adapter2(getApplicationContext(),(ArrayList<String>) product);
    ...
    private class Tsunami extends AsyncTask<URL, Void, String> {
        ...
        private void updateui(){
           ...
           RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(getApplicationContext());
            ...
            adapter2 Adapter = new adapter2(getApplicationContext(),(ArrayList<String>) product, (ArrayList<String>) pname);
