...
public class adapter2 extends RecyclerView.Adapter<adapter2.MyViewHolder> {
    ...
    public adapter2(Context applicationContext, ArrayList<String> product, ArrayList<String> nok) {
        this.coll = product;
        this.nn = nok;
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
       // notifyDataSetChanged();
        String s = MainActivity.movieList.get(adapter.k);
        String p = MainActivity.img.get(adapter.k);
        String c = product.pname.get(position);
        String u = String.valueOf(product.quanty.get(position));
